...
<div class="form">
<span align="center"><h3><font color="grey">Registration</font></h3></span><hr>
<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
<input type="text" name="email" placeholder="Email-Id"><br>
<input type="password" name="password" placeholder="Password"><br>
<input type="password" name="cpassword" placeholder="Confirm Password"><br>
<button name="submit">REGISTER</button><br><br><font color="grey">Already Registered?</font> <a href="login.php">Log In here</a>
</form>
...
if(isset($_POST['submit']))
{
	if(isset($_POST['email']) && isset($_POST['password']) && isset($_POST['cpassword']))
	{
		...
		$cpassword = mysqli_real_escape_string($conn , htmlspecialchars(trim(stripslashes($_POST['cpassword']))));
		...
		if($flag == 0)
		{
			...
			if(mysqli_num_rows($r1) == 0)
			{
				...
				{
					$q = "insert into registration(email, password, date, time) value('".$email."','".$password."','".$date."','".$time."')";
					$r = mysqli_query($conn,$q);
					if($r)
					{
						  
					$to_email = $email;
					$subject = 'Pikchoo | Thank You for your Registration';
					$message = 'Hi there,<br>Welcome to the Pikchoo family.<br>Your Log-In id: '.$email.' & Password: '.$password.'<br><br>Thank You,<br>Team Pikchoo<br><br><br>**Don\'t reply to this email.**';
					$headers = 'From: noreply@pikchoo.in';
					$m = mail($to_email,$subject,$message,$headers);
						
						echo '<br><p align="center"><font color="green">Your Login Id & Password is sent to your Email-Id. <br>Please Log In.<br>Thank You.</font></p>';
					}
				}
				else{
					echo '<br><p align="center"><font color="red">Both Passwords don\'t match.</font></p>';
				}
			
		    }else{
				echo '<br><p align="center"><font color="red">Email-Id already registered.</font></p>';
			}
