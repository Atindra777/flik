...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	*/
	...
	<font color="grey">
	<h1>FAQS</h1><br>
      <h2>What is Pikchoo?</h2>
      <h3>Pikchoo is an Online Photography gallery.</h3> 
	  <hr>
      <h2>How it Works?</h2>
      <h3>One can simply Upload & Download Images of their choices.</h3><hr>
	  <h2>Is it Safe?</h2>
	  <h3>Pikchoo is safe to use.<br>It has partnered with eminent Service Providers for Optimal Performance.<hr>
	  <h2>In case of problems whom to connect?</h2>
	  <h3>In case of any issues you can connect to Atindra Nath Sarkar.<br>Email-Id: atinsarkat@gmail.com<br>Mob: 9433356716.</h3><hr>
	</font>  
    </div>
    <div class="col-sm-2 sidenav">
      <?php
